export default function Home() {
  return (
    <main style={{
      ...
      background: 'linear-gradient(145deg, #f8f9fc 0%, #e8f0ff 100%)',
      padding: '4rem 1.5rem',
      minHeight: '100vh',
    }}>
      <div style={{
        ...
        <p style={{ fontWeight: 'bold', fontSize: '1.1rem', color: '#005FCE', marginBottom: '1rem' }}>
        ...
        <iframe
          ...
          style={{ borderRadius: '8px', border: '1px solid #ccc', background: '#fff' }}
        ></iframe>
        ...
        <footer style={{
          ...
          By submitting this form, you agree to be contacted by a licensed agent. This is not an offer of coverage. Coverage may be subject to underwriting. <br />
          © {new Date().getFullYear()} Retire From the Trades. All rights reserved.
        </footer>
      </div>
    </main>
  );
